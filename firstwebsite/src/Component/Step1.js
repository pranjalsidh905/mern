      ...
      >
        <div class="centerContainer contextStep firstLoad">
          <div class="regContainer" data-uia="context-registration">
            ...
            <div id="" class="contextBody contextRow" data-uia="regContextBody">
          ...
          <div class="submitBtnContainer">
            <button
              ...
              data-uia="cta-continue-registration"
              placeholder="registration_button_continue"
            >
              Next
            </button>
          </div>
              ...
              <div class="nfSelectPlacement globe">
                ...
                >
                  <option
                    ...
                    label="English"
                    lang="en"
                    value="/signup/registration?locale=en-IN"
                  >
                    English
                  </option>
                  <option
                    label="हिन्दी"
                    lang="hi"
                    value="/signup/registration?locale=hi-IN"
                  >
                    हिन्दी
                  </option>
                </select>
